...
class FedAU:
    ...
    def aggregate_models(self, server_model: CNNModel, client_model_params_dict: Dict[OrderedDict],
        ...
        fedavg_learning_classifier_params = fed_avg.aggregate_models(server_model, None,
                                                                     _learning_classifier_params_list)
        # on auxiliary classifiers (W_a) of drifted clients
        fedavg_auxiliary_classifier_params = fed_avg.aggregate_models(server_model, None,
                                                                      _auxiliary_classifier_params_list)
        # on extractors (E) of all clients
        fedavg_extractor_params = fed_avg.aggregate_models(server_model, None, extractors_params_list)
